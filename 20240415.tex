\pickl{15.04.2024}
\trt{In der Stochastik get es um die Modellierung von Experimenten, deren Ausgang vom Zufall abh\"angt.}
...
Die Potenzmenge $\Pcal(\Omega)$, d.h. die Menge aller Teilmengen $\Omega$, nennen wir \trt{Ereignismenge}.
...
Eine Abbildung $\PP\colon\Pcal(\Omega)\to\RR$ nennt man \trt{Wahrscheinlichkeitsma\ss{}} $:\LRA$
\abc{
...
Die Axiome a)-c) nennt man \trt{Axiome von Kolmogorow} (werden in 2 ebenfalls leicht angepasst).
\subsubsection{Satz}
...
Das Paar $(\Omega,\PP)$ nennt man auch \trt{Wahrscheinlichkeitsraum} (auch $(\Omega,\Pcal(\Omega),\PP)$).
