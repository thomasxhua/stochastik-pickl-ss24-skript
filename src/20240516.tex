...
Zwei reelle Zufallsvariablen $X,Y$ hei\ss{}en \trt{unabh\"angig} $:\Leftrightarrow$
...
\abc{
\item Die $(A_i)_{i\in\mathcal{I}}$ hei\ss{}en \trt{paarweise unabh\"angig} $:\Leftrightarrow A_j$ unabh\"angig von $A_k$, $\forall j\neq k\in\mathcal{I}$,
\item die $(A_i)_{i\in\mathcal{I}}$ hei\ss{}en \trt{unabh\"angig} $:\Leftrightarrow\forall\mathcal{J}\subset\mathcal{I}$ ist $\mathbb{P}(\bigcap_{j\in\mathcal{J}}A_j)=\prod_{j\in\mathcal{J}}\mathbb{P}(A_j)$ ($J$ ist abz\"ahlbar).
}
\subsubsection{Definition (paarweise Unabh\"angigkeit von Zufallsvariablen)}
Seien $(X_i)_{i\in\mathcal{I}}$ Zufallsvariablen.
\abc{
\item Die $(X_i)_{i\in\mathcal{I}}$ hei\ss{}en \trt{paarweise unabh\"angig} $:\Leftrightarrow X_j,X_k$ unabh\"angig $\forall j\neq k\in\mathcal{I}$,
\item die $(X_i)_{i\in\mathcal{I}}$ hei\ss{}en \trt{unabh\"angig} $:\Leftrightarrow\forall\mathcal{J}\subset\mathcal{I}$ abz\"ahlbar und $\forall(B_j)_{j\in\mathcal{J}}\subset\mathcal{B}_\mathbb{R}$ gilt $\mathbb{P}(\bigcap_{j\in\mathcal{J}}X_j\in B_j)=\prod_{i\in\mathcal{J}}\mathbb{P}(X_j\in B_j)$.
}
\subsubsection{Bemerkung}
