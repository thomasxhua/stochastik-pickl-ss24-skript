...
\abc{
\item Sei $\mathcal{E}\subset\mathcal{P}(\Omega),$ $\mathcal{A}\subset\mathcal{P}(\Omega)$ $\sigma$-Algebra. $\mathcal{E}\subset\mathcal{A}\Rightarrow\sigma(\mathcal{E})\subset\mathcal{A}$.
\item Seien $\mathcal{E},\mathcal{F}\subset\mathcal{P}(\Omega)$. Falls $\mathcal{E}\subset\sigma(\mathcal{F})$ und $\mathcal{F}\subset\sigma(\mathcal{E})\Rightarrow\sigma(\mathcal{E})=\sigma(\mathcal{F})$.
}
...
\item
\begin{align*}
\mathcal{E}\subset\sigma(\mathcal{F})&\ \textabove{a)}{\Rightarrow}\sigma(\mathcal{E})\subset\sigma(\mathcal{F}),\\
\mathcal{F}\subset\sigma(\mathcal{E})&\ \textabove{a)}{\Rightarrow}\sigma(\mathcal{F})\subset\sigma(\mathcal{E}).
\end{align*}
}
\subsubsection{Satz}
