\pickl{13.05.2024}
\subsubsection{Satz}
$X$ Zufallsvariable $\RA\mathbb{Q}:=\mathbb{P}\cdot X^{-1}$ ist Wahrscheinlichkeitsma\ss{}.
...
\begin{align*}
&\ \RA\forall n\in\mathbb{N}\ \exists B_n\in\mathcal{B}\ \text{mit}\ A_n=X^{-1}(B_n)\\
&\ \RA\bigcup_{n\in\mathbb{N}}B_n\in B\ \text{und}\ X^{-1}(\bigcup_{n\in\mathbb{N}}B_n)=\bigcup_{n\in\mathbb{N}}X^{-1}(B_n)\\
&\ \RA\bigcup_{n\in\mathbb{N}}A_n=\bigcup_{n\in\mathbb{N}}X^{-1}(B_n)=X^{-1}(\ubr{\bigcup_{n\in\mathbb{N}}B_n}{$\in\mathcal{B}$})\\
&\ \RA\bigcup_{n\in\mathbb{N}}A_n\in X^{-1}(\mathcal{B}).
\end{align*}
}
\item \"ahnlich.
}
